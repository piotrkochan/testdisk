...
{
  printf("\nUsage: photorec [/log] [/logname ...] [/logjson ...] [/sigfile ...] [/sessfile ...] [/nosess] [/debug] [/d recup_dir] [file.dd|file.e01|device]\n"\
      "       photorec /version\n" \
      "\n" \
      "/log              : create a photorec.log file\n" \
      "/logname <file>   : use alternative log file location  \n" \
      "/logjson <file>   : create log in JSON format\n" \
      "/sigfile <file>   : specify signature file\n" \
      "/sessfile <file>  : specify path to session file\n" \
